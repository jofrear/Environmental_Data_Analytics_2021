...
#matrix filtering in base R, same as above but different syntax
sample1 <- NTL.phys.data[NTL.phys.data$depth == 0, ]
...
#use F1 when highlighting a function name to open help
