...
ggplot(data=data.frame(x=0,y=0))+
  ...
  geom_text(x=0,y=0.025,label=expression(paste("Mean is," mu2, "R^{2},'=0.6'")))
print(Plot_text)
...
#alternate subsetting: filter(PeterPaul.chem.nutrients, depth==0)
plot1 <- ggplot(PeterPaul.chem.nutrients[PeterPaul.chem.nutrients$depth == 0,],
...
plot4a <- ggplot(EPAair, aes(x = Year, y = PM2.5)) + 
  geom_point()
print(plot4a)
# box plot
