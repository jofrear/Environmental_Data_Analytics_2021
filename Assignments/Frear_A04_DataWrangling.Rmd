...
Ozone_NC2018 <- read.csv("../Data/Raw/EPAair_O3_NC2018_raw.csv", 
                         stringsAsFactors = TRUE)
Ozone_NC2019 <- read.csv("../Data/Raw/EPAair_O3_NC2019_raw.csv", 
                         stringsAsFactors = TRUE)
...
#note from grader, you can use mutate as well: EPAair.PM25.NC2019.Processed %>% mutate(AQS_PARAMETER_DESC = "PM2.5"). 
...
#11
write.csv(EPAair_tidy, "../Data/Processed/EPAair_O3_PM25_NC1819_Processed_A04.csv")
```
...
> Answer: na.omit, by defalut, removes any row with an NA in any column, and you cannot easily force it to only look at specific columns, like drop_na does.
